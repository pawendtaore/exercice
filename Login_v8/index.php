<?ph require('actions/connexion.php');?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="wrap-login100">
				...
				?> 
					...
					<div class="wrap-input100 validate-input" data-validate = "Please enter password">
						<input class="input100" type="password" name="mot_de_passe" placeholder="mot_de_passe">
						<span class="focus-input100"></span>
					</div> <br><br>
					<div class="container-login100-form-btn">
						<button type="submit" class="login100-form-btn" name="validate">enregistrer</button>
					</div>
